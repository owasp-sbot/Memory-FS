...
class test_Memory_FS__File__Storage(TestCase):                                          # Test file storage configuration
    ...
    def test___init__(self):                                                            # Test initialization
    ...
    def test_file__paths(self):                                                         # Test file paths generation
        with self.file_storage as _:
